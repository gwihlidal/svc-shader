    ...
    pub mod shader {
        ...
        pub mod schema {
            ...
            const ENUM_VALUES_INPUT_FORMAT: [InputFormat; 2] =
                [InputFormat::Hlsl, InputFormat::Glsl];

            #[allow(non_camel_case_types)]
            const ENUM_NAMES_INPUT_FORMAT: [&'static str; 2] = ["Hlsl", "Glsl"];
            ...
            impl<'a> Artifact<'a> {
                ...
                pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                    ...
                    args: &'args ArtifactArgs<'args>,
                ) -> flatbuffers::WIPOffset<Artifact<'bldr>> {
                ...
                pub fn name(&self) -> Option<&'a str> {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Artifact::VT_NAME, None)
                }
                #[inline]
                pub fn input(&self) -> InputFormat {
                    self._tab
                        .get::<InputFormat>(Artifact::VT_INPUT, Some(InputFormat::Hlsl))
                        .unwrap()
                }
                #[inline]
                pub fn output(&self) -> OutputFormat {
                    self._tab
                        .get::<OutputFormat>(Artifact::VT_OUTPUT, Some(OutputFormat::Dxil))
                        .unwrap()
                }
                #[inline]
                pub fn identity(&self) -> Option<&'a str> {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Artifact::VT_IDENTITY, None)
                }
                #[inline]
                pub fn encoding(&self) -> Option<&'a str> {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Artifact::VT_ENCODING, None)
                }
                #[inline]
                pub fn profile(&self) -> Profile {
                    self._tab
                        .get::<Profile>(Artifact::VT_PROFILE, Some(Profile::Compute))
                        .unwrap()
                }
                #[inline]
                pub fn validated(&self) -> bool {
                    self._tab
                        .get::<bool>(Artifact::VT_VALIDATED, Some(false))
                        .unwrap()
                }
                #[inline]
            ...
            impl<'a: 'b, 'b> ArtifactBuilder<'a, 'b> {
                ...
                pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
                    self.fbb_
                        .push_slot_always::<flatbuffers::WIPOffset<_>>(Artifact::VT_NAME, name);
                }
                #[inline]
                pub fn add_input(&mut self, input: InputFormat) {
                    self.fbb_.push_slot::<InputFormat>(
                        Artifact::VT_INPUT,
                        input,
                        InputFormat::Hlsl,
                    );
                ...
                pub fn add_output(&mut self, output: OutputFormat) {
                    self.fbb_.push_slot::<OutputFormat>(
                        Artifact::VT_OUTPUT,
                        output,
                        OutputFormat::Dxil,
                    );
                ...
                pub fn add_profile(&mut self, profile: Profile) {
                    self.fbb_
                        .push_slot::<Profile>(Artifact::VT_PROFILE, profile, Profile::Compute);
                }
                #[inline]
                pub fn add_validated(&mut self, validated: bool) {
                    self.fbb_
                        .push_slot::<bool>(Artifact::VT_VALIDATED, validated, false);
                }
                #[inline]
                pub fn add_data(
                    &mut self,
                    ...
                    self.fbb_
                        .push_slot_always::<flatbuffers::WIPOffset<_>>(Artifact::VT_DATA, data);
                }
                #[inline]
                pub fn new(
            ...
            impl<'a> Shader<'a> {
                ...
                pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                    ...
                    if let Some(x) = args.artifacts {
                        builder.add_artifacts(x);
                    }
                ...
                pub fn entry(&self) -> Option<&'a str> {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Shader::VT_ENTRY, None)
                }
                #[inline]
                pub fn artifacts(
                    &self,
                ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Artifact<'a>>>>
                {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<flatbuffers::ForwardsUOffset<Artifact<'a>>>,
                    >>(Shader::VT_ARTIFACTS, None)
                }
            }
            ...
            pub struct ShaderArgs<'a> {
                ...
                pub artifacts: Option<
                    flatbuffers::WIPOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Artifact<'a>>>,
                    >,
                >,
            }
            ...
            impl<'a: 'b, 'b> ShaderBuilder<'a, 'b> {
                ...
                pub fn add_entry(&mut self, entry: flatbuffers::WIPOffset<&'b str>) {
                    self.fbb_
                        .push_slot_always::<flatbuffers::WIPOffset<_>>(Shader::VT_ENTRY, entry);
                }
                #[inline]
                pub fn add_artifacts(
                    &mut self,
                    artifacts: flatbuffers::WIPOffset<
                        flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Artifact<'b>>>,
                    >,
                ) {
                    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                        Shader::VT_ARTIFACTS,
            ...
            impl<'a> Manifest<'a> {
                ...
                pub fn shaders(
                    &self,
                ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Shader<'a>>>>
                {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<flatbuffers::ForwardsUOffset<Shader<'a>>>,
                    >>(Manifest::VT_SHADERS, None)
                }
            }
